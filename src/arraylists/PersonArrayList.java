...
public class PersonArrayList {
    ...
    public static int findInsertPoint (ArrayList<Person> a, Object searchValue){
	   int left = 0;
	   int right = a.size()-1;
	   int midpoint=0;
